...
def clouds_bqa_landsat(ee_img):
    ...
    dilated_cloud = int("0000000000001000", 2)
    cloud = int("0000000000001000", 2)
    shadow = int("0000000000001000", 2)
    return qa.bitwiseAnd(cloud).gt(0).Or(qa.bitwiseAnd(shadow).gt(0)).Or(qa.bitwiseAnd(dilated_cloud).gt(0))
